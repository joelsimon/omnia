function [seisdate, seiststr, seisertime, refdate, evtdate] = BSSA2020_seistime_NZMSEC_error(h)
% [seisdate, seiststr, seisertime, refdate, evtdate] = BSSA2020_SEISTIME_NZMSEC_ERROR(h)
%
% !!! DO NOT USE
% !!! IMPROPERLY HANDLES UTC TIMING
