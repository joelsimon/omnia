...
%                 dists, stdnorm)
%
% Changepoint Estimate Confidence Interval.
%
...
if iscell(x)
    ...
    for i = 1:iters
        ...
        if skip_alphas
            ...
            M2.unrestricted.span = M2.unrestricted.span + (xr_unrestricted ...
                                                           - ...
                                                           xl_unrestricted ...
                                                           + 1);
            M2.restricted.span = M2.restricted.span + (xr_restricted ...
                                                       - xl_restricted + 1);
            ...
            M2.unrestricted.h1 = M2.unrestricted.h1 + (xl_unrestricted ...
                                                       <= true_cp & ...
                                                       true_cp <= ...
                                                       xr_unrestricted);
            M2.restricted.h1 = M2.restricted.h1 + (xl_restricted <= ...
                                                   true_cp & true_cp ...
                                                   <= xr_restricted);
