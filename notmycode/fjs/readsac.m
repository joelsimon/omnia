...
% Last modified by jdsimon-at-princeton.edu, 3-Aug-2016


% Change log -
%
% 19-Aug-2018: added 'USER2'
%
% 03-Aug-2016: added 'O' (O, not zero), and 'USER0', 'USER1'
% Fixed(?): KNETWK, KSTNM Future improvement: increase precision of
% "K" fields, which are all 8 characters long, except for KEVNM, which
% is 16 characters long.  Currently just reading entire line; makes no
% difference (I think) other than appearance of whitespace after word
% < 8 characters
