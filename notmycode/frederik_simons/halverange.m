...
%
% Last modified by jdsimon-at-princeton.edu, Mar. 13, 2015 to turn
% off display; if halverange within another function (even if
% terminated with a semicolon), the range is still displayed in the
% command window
