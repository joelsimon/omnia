...
% I suppose.
%
% Last modified by fjsimons-at-alum.mit.edu, 07/10/2008
...
switch computer
    case 'MACI64'
        % Mac
        defval('diro','/Users/jdsimon/Dropbox/Mermaid/Misc.');
    otherwise
        % Linux
        addpath('/data1/jdsimon/Dropbox/MFILES')
        defval('diro','/data1/jdsimon/Dropbox/Mermaid/Misc.');
end
