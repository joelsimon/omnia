...
%
% Joel note: IF dispo=1 (internally) REID expects two angles (I assume
% P and S?) for phi.
%
% Last modified in Ver. 2017b by jdsimon@princeton.edu, 23-Aug-2018.

% Joel Note: dispo expects two
defval('MlMb',0)
