function ph = taup_majorphases
% ph = TAUP_MAJORPHASES
% 
% Returns list of all 'major' phases present from 0-180 degrees in
% Earth model ak135, as noted pp. 161 of "Seismological Tables:
% ak135" by B.L.N. Kennett (kennett+2005), converted to 'purist'
% name (no 'ab', 'bc' branch suffixes) for use in TauP.
%
% ph = ['P, PP, PcP, S, SS, ScS, ScP, SKS, PKP, PKIKP, SKIKS, SKP']
%
% Inputs: None
%
...
%
% See also: taup_majorPphases.m, taup_defaultphases.m
%
